...
import { addToCart, emptycartIteam, removeSingleIteams, removeToCart } from '../redux/features/cartSlice';
...
const CartDetails = () => {
    ...
    const makePayment = async()=>{
        const stripe = await loadStripe("pk_test_51Op2lWSFkkSGotmAqZhx1yw8NYEW794NsjzODlkhD9dXanOVpJReQLOyR3UDEobTD9d0shInMKSdYXmnk7qsqPjY00szxkei0x");
